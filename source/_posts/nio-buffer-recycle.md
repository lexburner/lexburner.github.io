...
![jvisualVM 主界面](https://image.cnkirito.cn/image-20190315193955214.png)

左侧树状目录可以选择需要监控的 Java 进程，右侧是监控的维度信息，除了 CPU、线程、堆、类等信息，还可以通过上方的【工具 (T)】 安装插件，增加 MBeans、Buffer Pools 等维度的监控。

![jvisualVM 插件](https://image.cnkirito.cn/image-20190315194046726.png)

Buffer Pools 插件可以监控堆外内存（包含 DirectByteBuffer 和 MappedByteBuffer），如下图所示：

![image-20190315194327416](https://image.cnkirito.cn/image-20190315194327416.png)
...
![image-20190315194712532](https://image.cnkirito.cn/image-20190315194712532.png)
...
![image-20190315201608522](https://image.cnkirito.cn/image-20190315201608522.png)
...
![GC](https://image.cnkirito.cn/image-20190315201756266.png)
...
![手动回收](https://image.cnkirito.cn/image-20190315201756266.png)
...
![mmap 手动回收](https://image.cnkirito.cn/image-20190315203424823.png)
...
![mmap 映射 1000G](https://image.cnkirito.cn/image-20190315203835758.png)
...
![实际消耗内存](https://image.cnkirito.cn/image-20190315204304382.png)
