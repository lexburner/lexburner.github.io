...
![开源程序员的日常](https://image.cnkirito.cn/image-20180827141007663.png)
...
![fork 与 clone](https://image.cnkirito.cn/image-20180827143942178.png)
...
![pull request](https://image.cnkirito.cn/image-20180827150703869.png)

pull request 经常被缩写为 PR，指的是一次向源仓库请求合并的行为，如上是我 fork 了 incubator-dubbo 的仓库之后才存在的操作按钮。

** 源仓库视角的 pull request**

![pull request management](https://image.cnkirito.cn/image-20180827155239155.png)
...
![CI 报告](https://image.cnkirito.cn/image-20180827160503114.png)
