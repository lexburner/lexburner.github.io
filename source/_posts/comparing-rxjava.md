...
![backpressure.jpg](https://image.cnkirito.cn/backpressure.jpg)
...
![macro-fusion_.png](https://image.cnkirito.cn/7fec27a062235dff88ef1d56ee2ce483.png)

**Micro-fusion** - 一个输出队列的结束操作，和在一个输入队列的开始操作，能够共享一个队列的实例。比如说，与其调用 `request(1)` 然后处理 onNext()`：

![micro-fusion-1_1.png](https://image.cnkirito.cn/6d4b0b357777b8caa2f87283027206ff.png)

不然让订阅者直接从父 `observable` 拉取值。

![micro-fusion-2.png](https://image.cnkirito.cn/fac526768bed14d11933464646eb6471.png)
...
![2018-04-12_20-38-07.png](https://image.cnkirito.cn/5a57f2b1b694cc0f41320763a0cb1c0a.png)
